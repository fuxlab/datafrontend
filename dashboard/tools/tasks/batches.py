...
def update_annotation_boundingboxes_category(batch_id):
    ...
    result = Annotation.boundingbox_objects.filter(id__in=batch.params_list(0)).update(category_id=batch.params_int(1))
...
def update_annotation_segmentations_category(batch_id):
    ...
    result = Annotation.segmentation_objects.filter(id__in=batch.params_list(0)).update(category_id=batch.params_int(1))
